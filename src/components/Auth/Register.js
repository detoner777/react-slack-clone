...
class Register extends React.Component {
    ...
    isFormValid = () => {
        ...
        if (this.isFormEmpty(this.state)) {
            ...
            return false;
        } else if (!this.isPassswordValid(this.state)){
            error = { message: 'Password is ivalid' };
            this.setState({ errors: errors.concat(error)});
            return false;
        }else{
            return true;
    ...
    isPassswordValid = ({ password, passwordConfirmation }) => {
            if(password.lengs < 6 || passwordConfirmation.length < 6) {
                return false;
                 ...
                 <Segment stacked>
                     <Form.Input fluid name="username" icon="user" iconPosition="left" 
                      ...
                      value={passwordConfirmation}/>
                        ...
                        <Button color="orange" fluid size0="large">Submit</Button>
